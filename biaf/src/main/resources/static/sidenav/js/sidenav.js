$(function(){
   ...
   if(conthref == "mypage" || conthref=="myedit" || conthref == "cart" || conthref == "orders" || conthref=="memberout" || conthref=="memberout1" || conthref=="reservationlist"){
   sidenav = '<ul class="dep1">'
   sidenav += '<h2>마이페이지</h2>'
   ...
   sidenav += '<li><a href="/ko/reservationlist">티켓예매/취소</a></li>'
